...
`Download for macOS (85.8 MB) <https://github.com/jbhagan/jwst_coronagraph_visibility/releases/download/0.4.4/jwst_coronagraph_visibility_tool_macos.zip>`_ | `Download Python source <https://github.com/jbhagan/jwst_coronagraph_visibility/archive/0.4.4.zip>`_ | ``$ pip install jwst-coronagraph-visibility``
